...
/datum/species/spider
	...
	sexes = 0
	say_mod = "chitters"
	default_color = "00FF00"							   /// VC SPECIES TODO
...
/datum/action/innate/spin_web/Activate()
	...
	var/obj/structure/spider/W2 = locate() in T
	if(W || W2)
	...
	if (H.nutrition >= nutrition_threshold)
		...
		new /obj/structure/spider(T, owner)
...
/datum/action/innate/spin_cocoon/proc/cocoonAtom(mob/living/carbon/human/species/spider/H, atom/movable/A)
	...
	if (!H || !isspiderperson(H))
		...
		if(!isliving(A) && A.anchored)
			...
			return
		if(istype(A, /obj/structure/spider))
		...
		var/obj/structure/spider/cocoon/C = new(A.loc)
		if(isliving(A))
