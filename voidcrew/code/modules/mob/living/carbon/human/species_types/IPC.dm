...
#define ETHEREAL_STOMACH_CHARGE_DRAW 40
/obj/item/apc_powercord/proc/powerdraw_loop(atom/target, mob/living/carbon/human/human, apc_target)
	...
	if(apc_target)
		...
		while(do_after(human, 10, target = eth_stomach.owner))
			...
			if(eth_stomach.crystal_charge == 0)
				...
				break
			siphon_amt = eth_stomach.crystal_charge <= ETHEREAL_STOMACH_CHARGE_DRAW ? eth_stomach.crystal_charge : ETHEREAL_STOMACH_CHARGE_DRAW
	...
	return
#undef ETHEREAL_STOMACH_CHARGE_DRAW
