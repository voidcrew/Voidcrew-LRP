/mob/living/simple_animal/hostile/cat_butcherer/CanAttack(atom/target)
	if(iscarbon(target))
		...
		if(carbon_target.getorgan(/obj/item/organ/ears/cat) && carbon_target.getorgan(/obj/item/organ/tail/cat) && carbon_target.has_trauma_type(/datum/brain_trauma/severe/pacifism))//he wont attack his creations
