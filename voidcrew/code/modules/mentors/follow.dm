/client/proc/mentor_follow(mob/living/followed_guy)
	...
	to_chat(GLOB.admins, "<span class ='adminooc'><span class='prefix'>MENTOR:</span> <EM>[key_name(usr)]</EM> is now following <EM>[key_name(followed_guy)]</EM></span>")
	to_chat(usr, "<span class ='info>Click the \"Stop Following\" button in the Mentor tab to stop following [key_name(followed_guy)].</span>")
...
/client/proc/mentor_unfollow()
	...
	to_chat(GLOB.admins, "<span class ='adminooc'><span class='prefix'>MENTOR:</span> <EM>[key_name(usr)]</EM> is no longer following <EM>[key_name(mentor_datum.following)]</EM></span>")
