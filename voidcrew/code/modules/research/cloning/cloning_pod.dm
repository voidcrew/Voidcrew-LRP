...
/obj/machinery/clonepod/proc/growclone(clonename, mutation_index, mindref, last_death, blood_type, datum/species/mrace, list/features, factions, list/quirks, datum/bank_account/insurance, list/traumas, empty)
	if(!beaker)
	...
	cloned_human.hardset_dna(mutation_index, null, cloned_human.real_name, blood_type, mrace, features)
