...
/obj/machinery/clonepod/experimental/growclone(
	...
	var/list/candidates = poll_candidates_for_mob("Do you want to play as [clonename]'s defective clone?", null, null, null, 100, cloned_human, POLL_IGNORE_DEFECTIVECLONE)
...
/obj/machinery/computer/prototype_cloning/proc/clone_occupant(occupant)
	...
	if(!LAZYLEN(pods))
		...
		pod.growclone(mob_occupant.real_name, dna.mutation_index, null, null, dna.blood_type, clone_species, dna.features, mob_occupant.faction)
