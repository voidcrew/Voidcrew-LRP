...
/obj/machinery/computer/cryopod
	...
	icon = 'voidcrew/icons/obj/machines/cryopods.dmi'
...
/obj/machinery/cryopod/proc/handle_objectives()
	...
	var/list/objectives = mob_occupant.mind.get_all_objectives()
...
/obj/machinery/cryopod/proc/despawn_occupant()
	...
	if(linked_ship)
		...
		if(mob_occupant.mind && mob_occupant.mind.assigned_role)
			...
			mob_occupant.mind.remove_all_antag_datums()
	...
	for(var/obj/item/W as anything in mob_occupant.get_all_contents())
