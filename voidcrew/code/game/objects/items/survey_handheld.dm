/obj/item/survey_handheld
	...
	icon = 'voidcrew/icons/obj/survey_handheld.dmi'
	icon_state = "survey"
...
/obj/item/survey_handheld/attack_self(mob/user)
	...
	while(user.get_active_held_item() == src)
		...
		var/penalty = 1 - (z_history[my_z] - 1) * 0.01 // You lose one percent of value and are one percent slower
		...
		playsound(src, 'voidcrew/sound/machines/whirr_beep.ogg', 20)
