...
/datum/controller/subsystem/shuttle/proc/initiate_jump()
	...
	for(var/obj/docking_port/mobile/mobile_port as anything in mobile_docking_ports)
...
/datum/controller/subsystem/shuttle/fire()
	for(var/obj/docking_port/mobile/mobile_port as anything in mobile_docking_ports)
		if(!mobile_port)
			mobile_docking_ports.Remove(mobile_port)
			continue
		mobile_port.check()

	for(var/obj/docking_port/stationary/transit/transit_dock as anything in transit_docking_ports)
