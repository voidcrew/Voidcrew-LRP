/datum/map_generator/cave_generator/rockplanet
	...
	flora_spawn_list = list(/obj/structure/mecha_wreckage/ripley = 5,
		/obj/structure/mecha_wreckage/ripley/mk2 = 3,
		...
		/obj/effect/spawner/random/maintenance = 30,
	...
	feature_spawn_list = list(/obj/structure/geyser/random = 1, /obj/effect/mine/shrapnel = 1)
