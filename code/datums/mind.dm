...
/datum/mind
	...
	//START VOIDCREW EDIT
	var/faction_hud_icon_state = null //this mind's FACTION HUD should have this icon_state
	var/datum/atom_hud/faction/faction_hud = null //this mind's FACTION HUD
	//END VOIDCREW EDIT
