...
/datum/skill/New()
	...
	span_nicegreen("After lots of practice, I've begun to truly understand the intricies and surprising depth behind [name]. I now condsider myself a master [title]."),
