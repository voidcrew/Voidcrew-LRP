...
#define METACOIN_SURVIVE_REWARD(is_speed_round, round_duration) is_speed_round ? 200 : max(min(round(50 * (round_duration / 72000)), 50), 50) // VOID CREW EDIT
...
#define METACOIN_TENMINUTELIVING_REWARD 35
